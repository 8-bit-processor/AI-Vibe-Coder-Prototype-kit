...
def build_system_prompt(programming_language, intent, project_context):
    ...
    """
    return (
        f"You are an expert software engineer specialized in {programming_language}. "
        "Your goal is to provide functional, complete, and idiomatic code that satisfies the user's request.\n\n"
        "### CAPABILITIES ###\n"
